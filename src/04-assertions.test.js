test('test obj', () => {
  const data = { name: 'Diana' }; // Para testear objetos se usa .toEqual.
  data.lastname = 'Florez'; // Manipulación del objeto.
  expect(data).toEqual({ name: 'Diana', lastname: 'Florez' }); // Espero que el objeto de arriba sea igual a este.
});
